        ...
        <div id="udraw-main-designer-ui">
            <div id="designer-menu" data-udraw="designerMenu">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" data-udraw="editDropdown" role="menu">
                        ...
                        <li role="presentation">
                            <a role="menuitem" href="#" data-udraw="toggleRuler"><span data-i18n="[html]menu_label.ruler"></span></a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="body-block">
                ...
                <div data-udraw="rightSidebar">
                    ...
                    <div id="threeD-box-modal" data-udraw="threeDBoxModal" class="widescreen_modal objectEditorContainer">
                        ...
                        <div id="threedbox-control-div" style="display:none;" data-udraw="threedBoxControlContainer">
                        </div>
                    </div>

                    <div id="threeD-preview-modal" data-udraw="threeDPreviewModal" class="widescreen_modal objectEditorContainer">
            ...
            <div id="toolbox-holder" data-udraw="toolboxContainer">
                ...
                <!-- Border Colours Modal -->
                <div class="modal toolbox-modal" style="top: 105px;" data-udraw="borderColourModal">
                    <div class="modal-dialog modal-md" style="margin: 0px auto 0px auto;">
                        <div class="modal-content">
                            <div class="modal-header toolbox-header">
                                <span data-i18n="[html]header_label.border"></span>
                                <div class="modal-header-btn-container" style="float:right;">
                                    <a href="#" class="btn btn-default btn-xs hide-toolbox" style="padding-top:0px;" data-udraw="toolboxHide"><i class="fa fa-chevron-up"></i><span data-i18n="[html]common_label.hide"></span></a>
                            ...
                            <div class="modal-body toolbox-body">
                                <div class="panel-body designer-panel-body">
                                    <div><span data-i18n="[html]text.border_select_colour"></span></div>
                                    <div data-colour="rgba(0,0,0,0)" class="colour_swatch select_border_colour transparent" style="background-color: rgba(0,0,0,0); display: none;"></div>
                                    <div data-udraw="border_colour_container"></div>
                                    
                                    <div data-udraw="custom_border_colour_picker_container" style="margin: 5px;">
                                        <input type="color" value="#000000" data-opacity="1" style="height:15px;" data-udraw="border_colour_picker" />
                                    </div>
                                    <div style="margin-top: 5px;" data-udraw="custom_border_thickness_container">
                                        <div>
                                            <span data-i18n="[html]text.custom_thickness"></span>
                                        </div>
                                        <span class="col-md-8">
                                            <span class="input-group">
                                                <span class="input-group-addon" data-i18n="[html]text_label.thickness"></span>
                                                <input class="form-control" type="text" value="0.25" data-udraw="border_thickness_spinner" />
                                                <span class="input-group-addon"><span data-i18n="[html]text_label.settings-inch">Inch</span></span>
                                            </span>
                                        </span>
                                    </div>
                                </div>
